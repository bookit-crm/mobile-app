...
export const ADMIN_MENU_CONFIG: ISideMenuItem[] = [
  ...
  { title: 'CLIENTS',       url: '/main/clients',       icon: 'person-outline',     feature: 'analytics',       minLevel: EFeatureLevel.BASIC },
  { title: 'PRODUCTS',      url: '/main/products',      icon: 'cube-outline',       feature: 'warehouse',       minLevel: EFeatureLevel.BASIC },
  ...
  { title: 'PROMO_CODES',   url: '/main/promo-codes',   icon: 'pricetag-outline',   feature: 'promoCodes' },
